# Generated by Django 3.1.5 on 2022-04-27 21:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='feedback',
            name='category_id',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='worker_deptment', to='my_app.category'),
        ),
        migrations.AddField(
            model_name='feedback',
            name='work_name',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='wrkname', to='my_app.work_details'),
        ),
        migrations.AddField(
            model_name='feedback',
            name='work_type',
